...
test.describe('NumInput', () => {
    ...
    test('Display', async ({ page }) => {
        await page.goto('http://127.0.0.1:3000/basics/num-input/display.html');
    ...
    test('默认参数', async ({ page }) => {
        await page.goto('http://127.0.0.1:3000/basics/num-input/operation.html');
    ...
    test('Readonly -> Enter', async ({ page }) => {
        await page.goto('http://127.0.0.1:3000/basics/num-input/readonly.html');
        const $operation = page.locator('#operation');
        const $operationEvent = page.locator('#operation-event');
    ...
    test('Disabled -> Enter', async ({ page }) => {
        await page.goto('http://127.0.0.1:3000/basics/num-input/disabled.html');
        const $operation = page.locator('#operation');
        const $operationEvent = page.locator('#operation-event');
        await $operation.click();
